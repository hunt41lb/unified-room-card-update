...
`;function fe(t){return t&&"none"!==t?`animation-${t}`:""}let ge=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,mainBasic:!0,mainIcon:!1,mainAppearance:!1,mainActions:!1,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._intermittentEntityExpanded=-1,this._customColorInputs=new Set,this._intermittentCustomColorInputs=new Set}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],s=i?i.split(".")[0]:"",a=re.includes(s);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._persistentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const n=`${e}-${i}`,s=t.color||"",a=this._customColorInputs.has(n)||s&&!Bt.some(t=>t.value===s),o=a?"custom":s;return G`
    ...
    `}_renderIntermittentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],s=i?i.split(".")[0]:"",a=re.includes(s);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._intermittentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const n=`i-${e}-${i}`,s=t.color||"",a=this._intermittentCustomColorInputs.has(n)||s&&!Bt.some(t=>t.value===s),o=a?"custom":s;return G`
              <div class="state-config-row">
                <ha-textfield
                  .value=${t.state||""}
...
`,console.info(`%c ${bt.toUpperCase()} %c v1.0.24 `,"color: white; background: #3498db; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #3498db; background: #ecf0f1; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");let Ce=xe=class extends lt{constructor(){super(...arguments),this._tapCount=0,this._updateAnimationState={isSpinning:!1}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_name:!0,show_icon:!0,show_state:!1,show_img_cell:!0,icon_animation:"none",tap_action:{action:"toggle"},hold_action:{action:"none"},double_tap_action:{action:"more-info"},...t}}getCardSize(){return 2}disconnectedCallback(){super.disconnectedCallback(),this._tapTimeout&&(clearTimeout(this._tapTimeout),this._tapTimeout=void 0),this._stopUpdateSpinTimer()}_startUpdateSpinTimer(){if(this._stopUpdateSpinTimer(),t=this._config?.update_entities,!0!==t?.spin_animation)return;var t;if(!this.hass||0===be(this.hass,this._config?.update_entities))return;const e=function(t){const e=t?.spin_interval??60;return 1e3*Math.max(10,e)}(this._config?.update_entities);this._triggerUpdateSpin(),this._updateSpinTimer=setInterval(()=>{this._triggerUpdateSpin()},e)}_stopUpdateSpinTimer(){this._updateSpinTimer&&(clearInterval(this._updateSpinTimer),this._updateSpinTimer=void 0),this._spinAnimationTimeout&&(clearTimeout(this._spinAnimationTimeout),this._spinAnimationTimeout=void 0)}_triggerUpdateSpin(){this._updateAnimationState={isSpinning:!0},this._spinAnimationTimeout=setTimeout(()=>{this._updateAnimationState={isSpinning:!1}},1e3)}static getConfigElement(){return document.createElement(Ct)}static getStubConfig(){return{type:`custom:${xt}`,name:"Room Name",entity:"",show_name:!0,show_icon:!0}}updated(t){super.updated(t),this._config?.grid_area?this.style.gridArea=this._config.grid_area:this.style.removeProperty("grid-area"),(t.has("hass")||t.has("_config"))&&(t.get("hass")&&!t.has("_config")||this._startUpdateSpinTimer())}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("_updateAnimationState"))return!0;if(t.has("hass")&&this._config){const e=t.get("hass");return!e||this._hasRelevantStateChanged(e)}return!1}_hasRelevantStateChanged(t){if(!this._config||!this.hass)return!1;const e=[];if(this._config.entity&&e.push(this._config.entity),this._config.persistent_entities?.entities&&e.push(...this._config.persistent_entities.entities.map(t=>t.entity)),this._config.intermittent_entities?.entities&&e.push(...this._config.intermittent_entities.entities.map(t=>t.entity)),this._config.climate_entities){const t=this._config.climate_entities;t.primary_entities&&e.push(...t.primary_entities),t.temperature_entities&&e.push(...t.temperature_entities),t.humidity_entities&&e.push(...t.humidity_entities),t.air_quality_entities&&e.push(...t.air_quality_entities),t.illuminance_entities&&e.push(...t.illuminance_entities)}this._config.power_entities?.entities&&e.push(...this._config.power_entities.entities),this._config.battery_entities?.entities&&e.push(...this._config.battery_entities.entities),this._config.update_entities?.entities&&e.push(...this._config.update_entities.entities);for(const i of e)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this._config||!this.hass)return F;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i={"state-on":e,"state-off":!e&&!!t},n=this._getBorderStyle(),s=function(t){const e=[];return t.cardHeight&&e.push(`height: ${t.cardHeight};`),t.cardWidth&&e.push(`width: ${t.cardWidth};`),t.gridTemplateAreas&&e.push(`grid-template-areas: ${t.gridTemplateAreas};`),t.gridTemplateColumns&&e.push(`grid-template-columns: ${t.gridTemplateColumns};`),t.gridTemplateRows&&e.push(`grid-template-rows: ${t.gridTemplateRows};`),t.backgroundGradient?e.push(`background: ${t.backgroundGradient};`):t.backgroundColor&&e.push(`background-color: ${t.backgroundColor};`),t.borderStyle&&e.push(`border: ${t.borderStyle};`),e.join(" ")}({cardHeight:this._config.card_height,cardWidth:this._config.card_width,gridTemplateAreas:this._config.grid?.template_areas,gridTemplateColumns:this._config.grid?.template_columns,gridTemplateRows:this._config.grid?.template_rows,backgroundColor:this._config.background_color,activeBackgroundColor:e?this._config.active_background_color:void 0,backgroundGradient:this._config.background_gradient,borderStyle:n}),a=this._usesLegacyGridAreas();return G`
      ...
      >
        ${this._renderName()}
        ${this._renderIcon()}
        ${this.hass?function(t,e,i){if(!e&&!i)return F;const n=e?.decimal_places??0,s=i?.decimal_places??0,a=!1!==e?.show_primary_unit,o=!1!==e?.show_temperature_unit,r=!1!==e?.show_humidity_unit,c=!1!==e?.show_air_quality_unit,l=!1!==e?.show_illuminance_unit,d=!1!==i?.show_unit;let h=null;e?.primary_entities&&e.primary_entities.length>0&&(h=function(t,e,i=0,n=!0){if(!e?.primary_entities||0===e.primary_entities.length)return null;const s=_e(t,e.primary_entities,i);return null===s.value?null:n&&s.unit?`${s.value}${s.unit}`:String(s.value)}(t,e,n,a)),h||(h=function(t,e,i=0,n=!0){if(!e?.temperature_entities||0===e.temperature_entities.length)return null;const s=_e(t,e.temperature_entities,i);if(null!==s.value){const t=n&&s.unit||"°";return`${s.value}${t}`}return null}(t,e,n,o));const p=function(t,e,i=0,n=!0){if(!e?.humidity_entities||0===e.humidity_entities.length)return null;const s=_e(t,e.humidity_entities,i);if(null!==s.value){const t=n?"%":"";return`${s.value}${t}`}return null}(t,e,n,r),u=function(t,e,i=0,n=!0){if(!e?.air_quality_entities||0===e.air_quality_entities.length)return null;const s=_e(t,e.air_quality_entities,i);if(null!==s.value){const t=n&&s.unit?s.unit:"";return`${s.value}${t}`}return null}(t,e,n,c),m=function(t,e,i=0,n=!0){if(!e?.illuminance_entities||0===e.illuminance_entities.length)return null;const s=_e(t,e.illuminance_entities,i);if(null!==s.value){const t=n?"lx":"";return`${s.value}${t}`}return null}(t,e,n,l),f=function(t,e,i=0,n=!0){if(!e?.entities||0===e.entities.length)return null;let s=0,a=0;for(const i of e.entities){const e=t.states[i];if(!e||ve(e))continue;const n=parseFloat(e.state);if(isNaN(n))continue;const o=e.attributes.unit_of_measurement,r=("string"==typeof o?o:"W").toLowerCase();s+="kw"===r?1e3*n:"mw"===r?1e6*n:"gw"===r?1e9*n:n,a++}if(0===a)return null;if(s>=1e3){const t=(s/1e3).toFixed(i);return n?`${t}kW`:t}const o=s.toFixed(i);return n?`${o}W`:o}(t,i,s,d),g=[];return p&&g.push({label:"humidity",value:p}),u&&g.push({label:"air quality",value:u}),m&&g.push({label:"illuminance",value:m}),f&&g.push({label:"power",value:f}),G`
  ...
  `}(this.hass,this._config?.climate_entities,this._config?.power_entities):F}
    ...
    `}_usesLegacyGridAreas(){const t=this._config?.grid?.template_areas;return!!t&&(t.includes("persistent")||t.includes("intermittent"))}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length,i=this._config?.battery_entities,n=this._config?.update_entities,s=this.hass?(a=this.hass,o=this._config?.battery_entities,o?$e(a,o).length:0):0;var a,o;const r=this.hass?be(this.hass,this._config?.update_entities):0;return t||e||0!==s||0!==r?G`
      <div class="status-section">
        ${this._renderPersistentEntities(!1)}
        ${this._renderIntermittentEntities(!1)}
        ${i&&this.hass?function(t,e,i){if(!e)return F;const n=$e(t,e);if(0===n.length)return F;const s=e.icon_size||"21px";return G`
    ${n.map(n=>function(t,e,i,n,s,a){const o=t.states[e];if(!o)return F;const r=ye(o),c=function(t){return null===t?"mdi:battery-unknown":t<=10?"mdi:battery-alert":t<=20?"mdi:battery-10":t<=30?"mdi:battery-20":t<=40?"mdi:battery-30":t<=50?"mdi:battery-40":t<=60?"mdi:battery-50":t<=70?"mdi:battery-60":t<=80?"mdi:battery-70":t<=90?"mdi:battery-80":"mdi:battery"}(r),l={"--mdc-icon-size":i,color:"var(--state-sensor-battery-low-color, var(--error-color, #db4437))"},d=s.tap_action||{action:"more-info"},h=s.hold_action||{action:"more-info"};return G`
    <div 
  ...
  `}(this.hass,this._config?.update_entities,this._handleEntityAction.bind(this),this._updateAnimationState):F}
    ...
    `:F}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i=!1!==this._config?.show_icon,n=this._config?.show_img_cell??!0,s=this._config?.icon||this._getDefaultIcon(t),a=t?this._getDomain(t.entity_id):"",o={"icon-container":!0,"with-img-cell":n,active:e,[fe(e&&"none"!==this._config?.icon_animation?this._config?.icon_animation:void 0)]:!0},r={};if(n&&this._config?.img_cell_size&&(r.width=this._config.img_cell_size,r.height=this._config.img_cell_size),e&&n){const e=this._getEntityBackgroundColor(t);r["background-color"]=e,r.background=e}const c={};if(this._config?.icon_size&&(c["--mdc-icon-size"]=this._config.icon_size,n||(r.width=this._config.icon_size,r.height=this._config.icon_size)),e&&n)c.color="var(--text-primary-color, #fff)";else if(t&&e)if("light"===a)c.color=this._getLightIconColor(t);else if("climate"===a)c.color=this._getClimateIconColor(t);else{const e=this._getEntityStateColor(t);c.color=e||"var(--state-active-color, var(--amber-color, #ffc107))"}else if(t&&"climate"===a)c.color=this._getClimateIconColor(t);else if(t){const e=this._getEntityStateColor(t);e&&(c.color=e)}const l={};switch(this._config?.icon_horizontal_position||Nt){case Dt:l["justify-self"]="start";break;case Ut:l["justify-self"]="center";break;default:l["justify-self"]="end"}switch(this._config?.icon_vertical_position||Mt){case Mt:l["align-self"]="start";break;case Ot:l["align-self"]="center";break;case Ht:l["align-self"]="end"}return G`
    ...
    `}_getPersistentEntityDefaultIcon(t,e){if("lock"===t)switch(e){case"locked":return"mdi:lock";case"unlocked":return"mdi:lock-open";case"locking":case"unlocking":return"mdi:lock-clock";case"jammed":return"mdi:lock-alert";default:return"mdi:lock-question"}if("binary_sensor"===t)return"on"===e?"mdi:motion-sensor":"mdi:motion-sensor-off";if("cover"===t)switch(e){case"open":case"opening":return"mdi:door-open";case"closed":case"closing":return"mdi:door-closed";default:return"mdi:door"}return"switch"===t?"on"===e?"mdi:toggle-switch":"mdi:toggle-switch-off":"light"===t?"on"===e?"mdi:lightbulb":"mdi:lightbulb-off":"mdi:help-circle"}_getPersistentEntityColor(t,e,i){if(i)return"var(--disabled-text-color, #9e9e9e)";if("lock"===t)switch(e){case"locked":return"var(--state-lock-locked-color, #43a047)";case"unlocked":return"var(--state-lock-unlocked-color, #ffc107)";case"locking":return"var(--state-lock-locking-color, #ffc107)";case"unlocking":return"var(--state-lock-unlocking-color, #ffc107)";case"jammed":return"var(--state-lock-jammed-color, #db4437)";case"open":return"var(--state-lock-open-color, #db4437)";default:return"var(--primary-text-color)"}if("binary_sensor"===t)return"on"===e?"var(--state-binary_sensor-active-color, var(--amber-color, #ffc107))":"var(--primary-text-color)";if("cover"===t)switch(e){case"open":case"opening":return"var(--state-cover-open-color, #ffc107)";case"closed":case"closing":return"var(--state-cover-closed-color, #43a047)";default:return"var(--primary-text-color)"}return"switch"===t?"on"===e?"var(--state-switch-active-color, var(--amber-color, #ffc107))":"var(--primary-text-color)":"light"===t?"on"===e?"var(--state-light-active-color, var(--amber-color, #ffc107))":"var(--primary-text-color)":"on"===e||"home"===e||"open"===e?"var(--state-active-color, var(--amber-color, #ffc107))":"var(--primary-text-color)"}_handlePersistentAction(t,e){if(this.hass)switch(t.action){case"more-info":this._fireMoreInfo(e);break;case"toggle":this.hass.callService("homeassistant","toggle",{entity_id:e});break;case"navigate":t.navigation_path&&(window.history.pushState(null,"",t.navigation_path),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0})));break;case"url":t.url_path&&window.open(t.url_path,"_blank");break;case"perform-action":if(t.service){const[e,i]=t.service.split(".");this.hass.callService(e,i,t.service_data||{})}}}_fireMoreInfo(t){const e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});this.dispatchEvent(e)}_renderIntermittentEntities(t=!1){if(!this._config?.intermittent_entities?.entities?.length||!this.hass)return F;const e=this._config.intermittent_entities,i=e.icon_size||"21px",n=e.gap||"4px",s=e.active_states,a=e.animation,o=(e.entities||[]).filter(t=>this._isIntermittentEntityActive(t,s));if(0===o.length)return F;const r={gap:n};return G`
      <div class=${_t({"intermittent-section":!0,"legacy-grid":t})} style=${wt(r)}>
