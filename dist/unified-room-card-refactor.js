        ...
        <div class="accordion-content ${t?"expanded":""}">
          ...
          <div class="form-row">
            ...
            <div class="form-input">
              <ha-selector
                .hass=${this.hass}
                .selector=${{entity:{domain:["sensor","climate","weather"],multiple:!0}}}
