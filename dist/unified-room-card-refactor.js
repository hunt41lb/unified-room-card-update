...
`;function me(t){return t&&"none"!==t?`animation-${t}`:""}let fe=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._intermittentEntityExpanded=-1,this._customColorInputs=new Set,this._intermittentCustomColorInputs=new Set}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],s=i?i.split(".")[0]:"",a=oe.includes(s);return G`
    ...
    `}_renderIntermittentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],s=i?i.split(".")[0]:"",a=oe.includes(s);return G`
      <div class="entity-row">
...
`,console.info(`%c ${bt.toUpperCase()} %c v1.0.23 `,"color: white; background: #3498db; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #3498db; background: #ecf0f1; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");let xe=be=class extends lt{constructor(){super(...arguments),this._tapCount=0,this._updateAnimationState={isSpinning:!1}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_name:!0,show_icon:!0,show_state:!1,show_img_cell:!0,animate_icon:!1,tap_action:{action:"toggle"},hold_action:{action:"none"},double_tap_action:{action:"more-info"},...t}}getCardSize(){return 2}disconnectedCallback(){super.disconnectedCallback(),this._tapTimeout&&(clearTimeout(this._tapTimeout),this._tapTimeout=void 0),this._stopUpdateSpinTimer()}_startUpdateSpinTimer(){if(this._stopUpdateSpinTimer(),t=this._config?.update_entities,!0!==t?.spin_animation)return;var t;if(!this.hass||0===$e(this.hass,this._config?.update_entities))return;const e=function(t){const e=t?.spin_interval??60;return 1e3*Math.max(10,e)}(this._config?.update_entities);this._triggerUpdateSpin(),this._updateSpinTimer=setInterval(()=>{this._triggerUpdateSpin()},e)}_stopUpdateSpinTimer(){this._updateSpinTimer&&(clearInterval(this._updateSpinTimer),this._updateSpinTimer=void 0),this._spinAnimationTimeout&&(clearTimeout(this._spinAnimationTimeout),this._spinAnimationTimeout=void 0)}_triggerUpdateSpin(){this._updateAnimationState={isSpinning:!0},this._spinAnimationTimeout=setTimeout(()=>{this._updateAnimationState={isSpinning:!1}},1e3)}static getConfigElement(){return document.createElement(Ct)}static getStubConfig(){return{type:`custom:${xt}`,name:"Room Name",entity:"",show_name:!0,show_icon:!0}}updated(t){super.updated(t),this._config?.grid_area?this.style.gridArea=this._config.grid_area:this.style.removeProperty("grid-area"),(t.has("hass")||t.has("_config"))&&(t.get("hass")&&!t.has("_config")||this._startUpdateSpinTimer())}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("_updateAnimationState"))return!0;if(t.has("hass")&&this._config){const e=t.get("hass");return!e||this._hasRelevantStateChanged(e)}return!1}_hasRelevantStateChanged(t){if(!this._config||!this.hass)return!1;const e=[];if(this._config.entity&&e.push(this._config.entity),this._config.persistent_entities?.entities&&e.push(...this._config.persistent_entities.entities.map(t=>t.entity)),this._config.intermittent_entities?.entities&&e.push(...this._config.intermittent_entities.entities.map(t=>t.entity)),this._config.climate_entities){const t=this._config.climate_entities;t.primary_entities&&e.push(...t.primary_entities),t.temperature_entities&&e.push(...t.temperature_entities),t.humidity_entities&&e.push(...t.humidity_entities),t.air_quality_entities&&e.push(...t.air_quality_entities),t.illuminance_entities&&e.push(...t.illuminance_entities)}this._config.power_entities?.entities&&e.push(...this._config.power_entities.entities),this._config.battery_entities?.entities&&e.push(...this._config.battery_entities.entities),this._config.update_entities?.entities&&e.push(...this._config.update_entities.entities);for(const i of e)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this._config||!this.hass)return F;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i={"state-on":e,"state-off":!e&&!!t},n=this._getBorderStyle(),s=function(t){const e=[];return t.cardHeight&&e.push(`height: ${t.cardHeight};`),t.cardWidth&&e.push(`width: ${t.cardWidth};`),t.gridTemplateAreas&&e.push(`grid-template-areas: ${t.gridTemplateAreas};`),t.gridTemplateColumns&&e.push(`grid-template-columns: ${t.gridTemplateColumns};`),t.gridTemplateRows&&e.push(`grid-template-rows: ${t.gridTemplateRows};`),t.backgroundGradient?e.push(`background: ${t.backgroundGradient};`):t.backgroundColor&&e.push(`background-color: ${t.backgroundColor};`),t.borderStyle&&e.push(`border: ${t.borderStyle};`),e.join(" ")}({cardHeight:this._config.card_height,cardWidth:this._config.card_width,gridTemplateAreas:this._config.grid?.template_areas,gridTemplateColumns:this._config.grid?.template_columns,gridTemplateRows:this._config.grid?.template_rows,backgroundColor:this._config.background_color,activeBackgroundColor:e?this._config.active_background_color:void 0,backgroundGradient:this._config.background_gradient,borderStyle:n}),a=this._usesLegacyGridAreas();return G`
  ...
  `}(this.hass,this._config?.climate_entities,this._config?.power_entities):F}
    ...
    `}_usesLegacyGridAreas(){const t=this._config?.grid?.template_areas;return!!t&&(t.includes("persistent")||t.includes("intermittent"))}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length,i=this._config?.battery_entities,n=this._config?.update_entities,s=this.hass?(a=this.hass,o=this._config?.battery_entities,o?ye(a,o).length:0):0;var a,o;const r=this.hass?$e(this.hass,this._config?.update_entities):0;return t||e||0!==s||0!==r?G`
      <div class="status-section">
        ${this._renderPersistentEntities(!1)}
        ${this._renderIntermittentEntities(!1)}
        ${i&&this.hass?function(t,e,i){if(!e)return F;const n=ye(t,e);if(0===n.length)return F;const s=e.icon_size||"21px";return G`
  ...
  `}(this.hass,this._config?.update_entities,this._handleEntityAction.bind(this),this._updateAnimationState):F}
      </div>
    ...
    `:F}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i=!1!==this._config?.show_icon,n=this._config?.show_img_cell??!0,s=this._config?.icon||this._getDefaultIcon(t),a=t?this._getDomain(t.entity_id):"",o={"icon-container":!0,"with-img-cell":n,active:e,[me(this._config?.animate_icon&&e?"pulse":void 0)]:!0},r={};if(n&&this._config?.img_cell_size&&(r.width=this._config.img_cell_size,r.height=this._config.img_cell_size),e&&n){const e=this._getEntityBackgroundColor(t);r["background-color"]=e,r.background=e}const c={};if(this._config?.icon_size&&(c["--mdc-icon-size"]=this._config.icon_size,n||(r.width=this._config.icon_size,r.height=this._config.icon_size)),e&&n)c.color="var(--text-primary-color, #fff)";else if(t&&e)if("light"===a)c.color=this._getLightIconColor(t);else if("climate"===a)c.color=this._getClimateIconColor(t);else{const e=this._getEntityStateColor(t);c.color=e||"var(--state-active-color, var(--amber-color, #ffc107))"}else if(t&&"climate"===a)c.color=this._getClimateIconColor(t);else if(t){const e=this._getEntityStateColor(t);e&&(c.color=e)}const l={};switch(this._config?.icon_horizontal_position||Ut){case zt:l["justify-self"]="start";break;case Dt:l["justify-self"]="center";break;default:l["justify-self"]="end"}switch(this._config?.icon_vertical_position||jt){case jt:l["align-self"]="start";break;case Mt:l["align-self"]="center";break;case Ot:l["align-self"]="end"}return G`
