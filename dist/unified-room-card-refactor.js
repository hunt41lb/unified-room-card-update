...
`;let fe=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,mainBasic:!0,mainIcon:!1,mainAppearance:!1,mainActions:!1,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._intermittentEntityExpanded=-1,this._customColorInputs=new Set,this._intermittentCustomColorInputs=new Set}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
      ...
      <div class="sub-accordion">
        ...
        <div class="sub-accordion-content ${t?"expanded":""}">
          ...
          ${e?G`
            ...
            ${"spin"===this._config?.icon_animation?G`
              <div class="form-row">
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],a=i?i.split(".")[0]:"",s=re.includes(a);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._persistentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const n=`${e}-${i}`,a=t.color||"",s=this._customColorInputs.has(n)||a&&!Rt.some(t=>t.value===a),o=s?"custom":a;return G`
    ...
    `}_renderIntermittentEntityConfig(t,e){const i=t.entity||"",n=i&&this.hass?.states[i],a=i?i.split(".")[0]:"",s=re.includes(a);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._intermittentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const n=`i-${e}-${i}`,a=t.color||"",s=this._intermittentCustomColorInputs.has(n)||a&&!Rt.some(t=>t.value===a),o=s?"custom":a;return G`
              <div class="state-config-row">
                <ha-textfield
                  .value=${t.state||""}
  ...
  `}(t,n,a,0,e,i))}
  `}function we(t,e){return e?ye(t,e).length:0}function be(t,e){const i=e.entities||[],n=[];for(const e of i){const i=t.states[e];i&&"on"===i.state&&n.push(e)}return n}function xe(t,e,i,n){if(!e)return F;const a=be(t,e);if(0===a.length)return F;const s=e.icon_size||"21px",o=e.color||"var(--state-update-active-color, var(--info-color, #039be5))",r=e.icon||"mdi:update",c=!0===e.spin_animation,l={"--mdc-icon-size":s,color:o},d=e.tap_action||{action:"more-info"},h=e.hold_action||{action:"more-info"},p=a[0],u=function(t,e){if(0===e.length)return"";if(1===e.length){const i=t.states[e[0]];return i?`${i.attributes.friendly_name||e[0]}: Update ${i.attributes.latest_version||"available"}`:"1 update available"}const i=e.map(e=>{const i=t.states[e];return i?.attributes.friendly_name||e});return`${e.length} updates available:\n${i.join("\n")}`}(t,a),m={"update-icon":!0,"spin-animation":c&&n.isSpinning};return G`
    <div 
      class="intermittent-entity"
...
`,console.info(`%c ${bt.toUpperCase()} %c v1.0.28 `,"color: white; background: #3498db; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #3498db; background: #ecf0f1; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");let ke=Se=class extends lt{constructor(){super(...arguments),this._tapCount=0,this._updateAnimationState={isSpinning:!1}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_name:!0,show_icon:!0,show_state:!1,show_img_cell:!0,icon_animation:"none",tap_action:{action:"toggle"},hold_action:{action:"none"},double_tap_action:{action:"more-info"},...t}}getCardSize(){return 2}disconnectedCallback(){super.disconnectedCallback(),this._tapTimeout&&(clearTimeout(this._tapTimeout),this._tapTimeout=void 0),this._stopUpdateSpinTimer()}_startUpdateSpinTimer(){if(this._stopUpdateSpinTimer(),t=this._config?.update_entities,!0!==t?.spin_animation)return;var t;if(!this.hass||0===Ce(this.hass,this._config?.update_entities))return;const e=function(t){const e=t?.spin_interval??60;return 1e3*Math.max(10,e)}(this._config?.update_entities);this._triggerUpdateSpin(),this._updateSpinTimer=setInterval(()=>{this._triggerUpdateSpin()},e)}_stopUpdateSpinTimer(){this._updateSpinTimer&&(clearInterval(this._updateSpinTimer),this._updateSpinTimer=void 0),this._spinAnimationTimeout&&(clearTimeout(this._spinAnimationTimeout),this._spinAnimationTimeout=void 0)}_triggerUpdateSpin(){this._updateAnimationState={isSpinning:!0},this._spinAnimationTimeout=setTimeout(()=>{this._updateAnimationState={isSpinning:!1}},1e3)}static getConfigElement(){return document.createElement(Ct)}static getStubConfig(){return{type:`custom:${xt}`,name:"Room Name",entity:"",show_name:!0,show_icon:!0}}updated(t){super.updated(t),this._config?.grid_area?this.style.gridArea=this._config.grid_area:this.style.removeProperty("grid-area"),(t.has("hass")||t.has("_config"))&&(t.get("hass")&&!t.has("_config")||this._startUpdateSpinTimer())}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("_updateAnimationState"))return!0;if(t.has("hass")&&this._config){const e=t.get("hass");return!e||this._hasRelevantStateChanged(e)}return!1}_hasRelevantStateChanged(t){if(!this._config||!this.hass)return!1;const e=[];if(this._config.entity&&e.push(this._config.entity),this._config.persistent_entities?.entities&&e.push(...this._config.persistent_entities.entities.map(t=>t.entity)),this._config.intermittent_entities?.entities&&e.push(...this._config.intermittent_entities.entities.map(t=>t.entity)),this._config.climate_entities){const t=this._config.climate_entities;t.primary_entities&&e.push(...t.primary_entities),t.temperature_entities&&e.push(...t.temperature_entities),t.humidity_entities&&e.push(...t.humidity_entities),t.air_quality_entities&&e.push(...t.air_quality_entities),t.illuminance_entities&&e.push(...t.illuminance_entities)}this._config.power_entities?.entities&&e.push(...this._config.power_entities.entities),this._config.battery_entities?.entities&&e.push(...this._config.battery_entities.entities),this._config.update_entities?.entities&&e.push(...this._config.update_entities.entities);for(const i of e)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this._config||!this.hass)return F;const t=this._config.entity?this.hass.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i={"state-on":e,"state-off":!e&&!!t},n=this._getBorderStyle(),a=function(t){const e=[];return t.cardHeight&&e.push(`height: ${t.cardHeight};`),t.cardWidth&&e.push(`width: ${t.cardWidth};`),t.gridTemplateAreas&&e.push(`grid-template-areas: ${t.gridTemplateAreas};`),t.gridTemplateColumns&&e.push(`grid-template-columns: ${t.gridTemplateColumns};`),t.gridTemplateRows&&e.push(`grid-template-rows: ${t.gridTemplateRows};`),t.backgroundGradient?e.push(`background: ${t.backgroundGradient};`):t.backgroundColor&&e.push(`background-color: ${t.backgroundColor};`),t.borderStyle&&e.push(`border: ${t.borderStyle};`),e.join(" ")}({cardHeight:this._config.card_height,cardWidth:this._config.card_width,gridTemplateAreas:this._config.grid?.template_areas,gridTemplateColumns:this._config.grid?.template_columns,gridTemplateRows:this._config.grid?.template_rows,backgroundColor:this._config.background_color,activeBackgroundColor:e?this._config.active_background_color:void 0,backgroundGradient:this._config.background_gradient,borderStyle:n}),s=this._getDefinedGridAreas();return G`
  ...
  `}(this.hass,this._config?.climate_entities,this._config?.power_entities):F}
    ...
    `}_getDefinedGridAreas(){const t=this._config?.grid?.template_areas||"";return{hasCustomGrid:t.length>0,hasPersistentArea:t.includes("persistent"),hasIntermittentArea:t.includes("intermittent"),hasBatteryArea:t.includes("battery"),hasUpdateArea:t.includes("update")}}_renderEntitySections(t){const{hasCustomGrid:e,hasPersistentArea:i,hasIntermittentArea:n,hasBatteryArea:a,hasUpdateArea:s}=t;if(!(i||n||a||s))return this._renderStatusSection();const o=!a,r=!s;return G`
      ${i&&this.hass?Ae(this.hass,this._config?.persistent_entities,this,!0,this._handleEntityAction.bind(this)):F}
    ...
    `:F}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length,i=this._config?.battery_entities,n=this._config?.update_entities,a=this.hass?we(this.hass,this._config?.battery_entities):0,s=this.hass?Ce(this.hass,this._config?.update_entities):0;return t||e||0!==a||0!==s?G`
      <div class="status-section">
        ${this.hass?Ae(this.hass,this._config?.persistent_entities,this,!1,this._handleEntityAction.bind(this)):F}
    ...
    `:F}_renderIcon(){const t=this._config?.entity?this.hass?.states[this._config.entity]:void 0,e=!!t&&this._isEntityActive(t.entity_id,t.state,t.attributes),i=!1!==this._config?.show_icon,n=this._config?.show_img_cell??!0,a=this._config?.icon||this._getDefaultIcon(t),s=t?this._getDomain(t.entity_id):"",o=e&&this._config?.icon_animation&&"none"!==this._config.icon_animation&&(r=this._config.icon_animation)&&"none"!==r?`animation-${r}`:"";var r;const c={"icon-container":!0,"with-img-cell":n,active:e};o&&(c[o]=!0);const l={};if("spin"===this._config?.icon_animation&&e){const t=this._config?.spin_duration||2;l["--spin-duration"]=`${t}s`}if(n&&this._config?.img_cell_size&&(l.width=this._config.img_cell_size,l.height=this._config.img_cell_size),e&&n){const e=this._getEntityBackgroundColor(t);l["background-color"]=e,l.background=e}const d={};if(this._config?.icon_size&&(d["--mdc-icon-size"]=this._config.icon_size,n||(l.width=this._config.icon_size,l.height=this._config.icon_size)),e&&n)d.color="var(--text-primary-color, #fff)";else if(t&&e)if("light"===s)d.color=this._getLightIconColor(t);else if("climate"===s)d.color=this._getClimateIconColor(t);else{const e=this._getEntityStateColor(t);d.color=e||"var(--state-active-color, var(--amber-color, #ffc107))"}else if(t&&"climate"===s)d.color=this._getClimateIconColor(t);else if(t){const e=this._getEntityStateColor(t);e&&(d.color=e)}const h={};switch(this._config?.icon_horizontal_position||Nt){case Dt:h["justify-self"]="start";break;case Ut:h["justify-self"]="center";break;default:h["justify-self"]="end"}switch(this._config?.icon_vertical_position||Mt){case Mt:h["align-self"]="start";break;case Ot:h["align-self"]="center";break;case Ht:h["align-self"]="end"}return G`
    ...
    `}_isIntermittentEntityActive(t,e){if(!this.hass)return!1;const i=this.hass.states[t.entity];if(!i)return!1;if(["unavailable","unknown"].includes(i.state))return!1;const n=i.state,a=t.entity.split(".")[0];return(t.active_states||e||ie[a]||["on"]).includes(n)}_renderIntermittentEntity(t,e,i){if(!this.hass)return F;const n=this.hass.states[t.entity];if(!n)return F;const a=n.state,s=t.entity.split(".")[0];let o=t.icon;const r=t.states?.find(t=>t.state===a);r?.icon?o=r.icon:o||(o=this._getIntermittentEntityDefaultIcon(s,a,n));let c=this._getIntermittentEntityColor(s,a);r?.color&&(c=r.color);const l=r?.animation||t.animation||i,d=t.icon_size||e,h=t.tap_action||{action:"more-info"},p=t.hold_action||{action:"more-info"},u={"--mdc-icon-size":d,color:c};return G`
      <div 
        ...
        title="${n.attributes.friendly_name||t.entity}: ${a}"
      >
        <ha-icon
          .icon=${o}
          style=${wt(u)}
