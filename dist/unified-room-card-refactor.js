...
`;function ue(t){return t&&"none"!==t?`animation-${t}`:""}let me=class extends lt{constructor(){super(...arguments),this._accordionState={main:!0,persistent:!1,intermittent:!1,climate:!1,power:!1,battery:!1,update:!1,grid:!1},this._persistentEntityExpanded=-1,this._intermittentEntityExpanded=-1,this._customColorInputs=new Set,this._intermittentCustomColorInputs=new Set}setConfig(t){this._config=t}render(){return this.hass&&this._config?G`
    ...
    `}_renderPersistentEntityConfig(t,e){const i=t.entity||"",s=i&&this.hass?.states[i],n=i?i.split(".")[0]:"",a=oe.includes(n);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._persistentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const s=`${e}-${i}`,n=t.color||"",a=this._customColorInputs.has(s)||n&&!Rt.some(t=>t.value===n),o=a?"custom":n;return G`
    ...
    `}_renderIntermittentEntityConfig(t,e){const i=t.entity||"",s=i&&this.hass?.states[i],n=i?i.split(".")[0]:"",a=oe.includes(n);return G`
      <div class="entity-row">
        ...
        <div class="entity-config ${this._intermittentEntityExpanded===e?"expanded":""}">
          ...
          ${(t.states||[]).map((t,i)=>{const s=`i-${e}-${i}`,n=t.color||"",a=this._intermittentCustomColorInputs.has(s)||n&&!Rt.some(t=>t.value===n),o=a?"custom":n;return G`
              <div class="state-config-row">
                <ha-textfield
                  .value=${t.state||""}
    ...
    `}_getPrimaryEntityDeviceClass(){const t=this._config?.climate_entities?.primary_entities;if(!t||0===t.length||!this.hass)return;const e=this.hass.states[t[0]];return e?e.attributes.device_class:void 0}_getPrimaryEntitySelector(){const t=this._getPrimaryEntityDeviceClass();return t?{entity:{domain:"sensor",device_class:t,multiple:!0}}:{entity:{domain:["sensor","climate","weather"],multiple:!0}}}_getPowerEntityUnit(){const t=this._config?.power_entities?.entities;if(!t||0===t.length||!this.hass)return;const e=this.hass.states[t[0]];if(!e)return;const i=e.attributes.unit_of_measurement;return"string"==typeof i?i:void 0}_getPowerEntitySelector(){const t=this._getPowerEntityUnit();return t?{entity:{domain:"sensor",device_class:{W:["power"],kW:["power"],MW:["power"],Wh:["energy"],kWh:["energy"],MWh:["energy"],A:["current"],mA:["current"],V:["voltage"],mV:["voltage"]}[t]||["power","energy","voltage","current"],multiple:!0}}:{entity:{domain:"sensor",device_class:["power","energy","voltage","current"],multiple:!0}}}_toggleAccordion(t){this._accordionState={...this._accordionState,[t]:!this._accordionState[t]}}_valueChanged(t,e){if(!this._config)return;const i={...this._config,[t]:e};""!==e&&null!=e||delete i[t],this._config=i,this._dispatchConfigChanged()}_gridValueChanged(t,e){if(!this._config)return;const i={...this._config.grid}||{};e?i[t]=e:delete i[t],this._config={...this._config,grid:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_tapActionChanged(t,e){if(!this._config)return;const i={...this._config,[t]:{action:e}};this._config=i,this._dispatchConfigChanged()}_tapActionDataChanged(t,e,i){if(!this._config)return;const s=this._config[t]||{action:"none"},n={...this._config,[t]:{...s,[e]:i||void 0}};i||delete n[t][e],this._config=n,this._dispatchConfigChanged()}_climateValueChanged(t,e){if(!this._config)return;const i={...this._config.climate_entities}||{};Array.isArray(e)&&0===e.length||""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,climate_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_powerValueChanged(t,e){if(!this._config)return;const i={...this._config.power_entities}||{};Array.isArray(e)&&0===e.length||""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,power_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_persistentValueChanged(t,e){if(!this._config)return;const i={...this._config.persistent_entities}||{};""===e||null==e?delete i[t]:i[t]=e,this._config={...this._config,persistent_entities:Object.keys(i).length>0?i:void 0},this._dispatchConfigChanged()}_togglePersistentEntityExpand(t){this._persistentEntityExpanded=this._persistentEntityExpanded===t?-1:t}_addPersistentEntity(){if(!this._config)return;const t={...this._config.persistent_entities}||{},e=[...t.entities||[]];e.push({entity:""}),t.entities=e,this._config={...this._config,persistent_entities:t},this._persistentEntityExpanded=e.length-1,this._dispatchConfigChanged()}_removePersistentEntity(t){if(!this._config)return;const e={...this._config.persistent_entities}||{},i=[...e.entities||[]];i.splice(t,1),e.entities=i.length>0?i:void 0,this._config={...this._config,persistent_entities:Object.keys(e).filter(t=>void 0!==e[t]).length>0?e:void 0},this._persistentEntityExpanded===t&&(this._persistentEntityExpanded=-1),this._dispatchConfigChanged()}_updatePersistentEntity(t,e,i){if(!this._config)return;const s={...this._config.persistent_entities}||{},n=[...s.entities||[]];n[t]&&(n[t][e]=i||void 0,i||delete n[t][e]),s.entities=n,this._config={...this._config,persistent_entities:s},this._dispatchConfigChanged()}_addPersistentEntityState(t){if(!this._config)return;const e={...this._config.persistent_entities}||{},i=[...e.entities||[]];if(i[t]){const e={...i[t]};e.states=[...e.states||[],{state:"",icon:"",color:""}],i[t]=e}e.entities=i,this._config={...this._config,persistent_entities:e},this._dispatchConfigChanged()}_removePersistentEntityState(t,e){if(!this._config)return;const i={...this._config.persistent_entities}||{},s=[...i.entities||[]];if(s[t]){const i={...s[t]},n=[...i.states||[]];n.splice(e,1),i.states=n.length>0?n:void 0,s[t]=i}i.entities=s,this._config={...this._config,persistent_entities:i},this._dispatchConfigChanged()}_updatePersistentEntityState(t,e,i,s){if(!this._config)return;const n={...this._config.persistent_entities}||{},a=[...n.entities||[]];if(a[t]){const n={...a[t]},o=[...n.states||[]];o[e]&&(o[e][i]=s||void 0,s||delete o[e][i]),n.states=o,a[t]=n}n.entities=a,this._config={...this._config,persistent_entities:n},this._dispatchConfigChanged()}_renderColorOptions(){const t=[];let e="";for(const i of Rt)i.category!==e&&(e=i.category,"Default"!==e&&t.push(G`
      ...
      >
        ${this._renderName()}
        ${this._renderIcon()}
        ${this.hass?function(t,e,i){if(!e&&!i)return F;const s=e?.decimal_places??0,n=i?.decimal_places??0,a=!1!==e?.show_primary_unit,o=!1!==e?.show_temperature_unit,r=!1!==e?.show_humidity_unit,c=!1!==e?.show_air_quality_unit,l=!1!==e?.show_illuminance_unit,d=!1!==i?.show_unit;let h=null;e?.primary_entities&&e.primary_entities.length>0&&(h=function(t,e,i=0,s=!0){if(!e?.primary_entities||0===e.primary_entities.length)return null;const n=ge(t,e.primary_entities,i);return null===n.value?null:s&&n.unit?`${n.value}${n.unit}`:String(n.value)}(t,e,s,a)),h||(h=function(t,e,i=0,s=!0){if(!e?.temperature_entities||0===e.temperature_entities.length)return null;const n=ge(t,e.temperature_entities,i);if(null!==n.value){const t=s&&n.unit||"°";return`${n.value}${t}`}return null}(t,e,s,o));const p=function(t,e,i=0,s=!0){if(!e?.humidity_entities||0===e.humidity_entities.length)return null;const n=ge(t,e.humidity_entities,i);if(null!==n.value){const t=s?"%":"";return`${n.value}${t}`}return null}(t,e,s,r),u=function(t,e,i=0,s=!0){if(!e?.air_quality_entities||0===e.air_quality_entities.length)return null;const n=ge(t,e.air_quality_entities,i);if(null!==n.value){const t=s&&n.unit?n.unit:"";return`${n.value}${t}`}return null}(t,e,s,c),m=function(t,e,i=0,s=!0){if(!e?.illuminance_entities||0===e.illuminance_entities.length)return null;const n=ge(t,e.illuminance_entities,i);if(null!==n.value){const t=s?"lx":"";return`${n.value}${t}`}return null}(t,e,s,l),f=function(t,e,i=0,s=!0){if(!e?.entities||0===e.entities.length)return null;let n=0,a=0;for(const i of e.entities){const e=t.states[i];if(!e||fe(e))continue;const s=parseFloat(e.state);if(isNaN(s))continue;const o=e.attributes.unit_of_measurement,r=("string"==typeof o?o:"W").toLowerCase();n+="kw"===r?1e3*s:"mw"===r?1e6*s:"gw"===r?1e9*s:s,a++}if(0===a)return null;if(n>=1e3){const t=(n/1e3).toFixed(i);return s?`${t}kW`:t}const o=n.toFixed(i);return s?`${o}W`:o}(t,i,n,d),g=[];return p&&g.push({label:"humidity",value:p}),u&&g.push({label:"air quality",value:u}),m&&g.push({label:"illuminance",value:m}),f&&g.push({label:"power",value:f}),G`
  ...
  `}(this.hass,this._config?.climate_entities,this._config?.power_entities):F}
    ...
    `}_usesLegacyGridAreas(){const t=this._config?.grid?.template_areas;return!!t&&(t.includes("persistent")||t.includes("intermittent"))}_renderStatusSection(){const t=this._config?.persistent_entities?.entities?.length,e=this._config?.intermittent_entities?.entities?.length,i=this._config?.battery_entities,s=this._config?.update_entities,n=this.hass?(a=this.hass,o=this._config?.battery_entities,o?_e(a,o).length:0):0;var a,o;const r=this._getPendingUpdateCount();return t||e||0!==n||0!==r?G`
      <div class="status-section">
        ${this._renderPersistentEntities(!1)}
        ${this._renderIntermittentEntities(!1)}
        ${i&&this.hass?function(t,e,i){if(!e)return F;const s=_e(t,e);if(0===s.length)return F;const n=e.icon_size||"21px";return G`
    ${s.map(s=>function(t,e,i,s,n,a){const o=t.states[e];if(!o)return F;const r=ve(o),c=function(t){return null===t?"mdi:battery-unknown":t<=10?"mdi:battery-alert":t<=20?"mdi:battery-10":t<=30?"mdi:battery-20":t<=40?"mdi:battery-30":t<=50?"mdi:battery-40":t<=60?"mdi:battery-50":t<=70?"mdi:battery-60":t<=80?"mdi:battery-70":t<=90?"mdi:battery-80":"mdi:battery"}(r),l={"--mdc-icon-size":i,color:"var(--state-sensor-battery-low-color, var(--error-color, #db4437))"},d=n.tap_action||{action:"more-info"},h=n.hold_action||{action:"more-info"};return G`
    <div 
